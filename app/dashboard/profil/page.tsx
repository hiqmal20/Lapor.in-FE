        ...
        <div className="flex items-start justify-between gap-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span className="text-xs px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 font-medium flex items-center gap-1">
                  <User size={10} />
                  {profile.role === "super_admin" ? "Super Admin" : profile.role === "admin" ? "Admin" : "Citizen"}
                </span>
          ...
          {!editing ? (
            ...
            <div className="flex gap-2 shrink-0">
              <Button size="sm" variant="outline" onClick={handleCancelEdit} disabled={saving} className="text-xs gap-1.5 border-gray-200">
                <X size={13} /> Cancel
              </Button>
      ...
      <div className="bg-white border border-gray-100 rounded-xl p-5">
        ...
        {showPasswordForm && (
          <div className="mt-4 space-y-3">
            {passwordError && (
              <div className="bg-red-50 border border-red-200 text-red-600 text-xs px-3 py-2 rounded-lg">{passwordError}</div>
            )}
            {passwordSuccess && (
            ...
            {[
              ...
              <div key={key}>
                ...
                <Input
                  ...
                  className="h-9 text-sm border-gray-200 focus:border-blue-400 bg-gray-50 transition-colors"
                />
              </div>
            ))}
