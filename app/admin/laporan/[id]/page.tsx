  ...
  const handleDeleteLaporan = async () => {
    ...
    try {
      ...
      if (ok) {
        ...
        router.refresh(); // Refresh dashboard untuk update list laporan
      } else {
        ...
        <div className="flex items-center gap-2">
          ...
          {!editing && (
            <Button
              ...
              className="text-xs gap-1.5 bg-red-500 hover:bg-red-600 text-white transition-all duration-200"
            >
              <Trash2 size={13} />
              Delete Report
            </Button>
